...
export const USE_CASES = [
  ...
  { id: 5,  title: "Track your fleet",            category: "Tracking",   complexity: "High",   mapType: "fleet",     accent: "general",     mapStyle: "driving",   status: "live", description: "Build a fleet ops view with the TomTom Routing API and a real municipality boundary pulled from Admin Boundaries. Each van geocodes two endpoints, gets a snapped route between them, and animates a marker along the polyline. The operating-zone polygon is the real city boundary, not a hand-drawn box. Customise the route and marker colours below to match your dispatch UI.", tags: ["fleet", "tracking", "geofence", "live"],
    tools: [
      { name: "Orbis Maps SDK",   type: "sdk" },
    ...
    params: [
      { key: 'markerColor', label: 'Vehicle colour', type: 'color', default: '#646E7B' },
      { key: 'routeColor',  label: 'Route colour',   type: 'color', default: '#646E7B' },
      { key: 'lineStyle',   label: 'Route style',    type: 'select', default: 'solid',
        options: [
          { value: 'solid',  label: 'Solid' },
          { value: 'dashed', label: 'Dashed' },
          { value: 'dotted', label: 'Dotted' },
